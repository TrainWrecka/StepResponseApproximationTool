...
public class InputPanel extends JPanel implements ActionListener {
    ...
    private JLabel lbwp1 = new JLabel("\03C9p1:");
    private JLabel lbwq1 = new JLabel("\03C9q1:");
    private JLabel lbwp2 = new JLabel("\03C9p2:");
    private JLabel lbwq2 = new JLabel("\03C9q2:");
    private JLabel lbwp3 = new JLabel("\03C9p3:");
    private JLabel lbwq3 = new JLabel("\03C9q3:");
    private JLabel lbwp4 = new JLabel("\03C9p4:");
    private JLabel lbwq4 = new JLabel("\03C9q4:");
    private JLabel lbwp5 = new JLabel("\03C9p5:");
    private JLabel lbwq5 = new JLabel("\03C9q5:");
    private JLabel lbwp6 = new JLabel("\03C9p6:");
    private JLabel lbwq6 = new JLabel("\03C9q6:");
    private JLabel lbwp7 = new JLabel("\03C9p7:");
    private JLabel lbwq7 = new JLabel("\03C9q7:");
    private JLabel lbwp8 = new JLabel("\03C9p8:");
    private JLabel lbwq8 = new JLabel("\03C9q8:");
    private JLabel lbwp9 = new JLabel("\03C9p9:");
    private JLabel lbwq9 = new JLabel("\03C9q9:");
    private JLabel lbwp10 = new JLabel("\03C9p10:");
    private JLabel lbwq10 = new JLabel("\03C9q10:");
    private JLabel lbSigma=new JLabel("\03C3:");
    // Textfields
	...
	public InputPanel(){
		...
		add(btLoad,new GridBagConstraints( 0, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH,  
		...
		add(lbOrdnung,new GridBagConstraints( 0, 3, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH,  
				new Insets(10, 10, 0, 10), 0, 0));
		add(lbwp1,new GridBagConstraints( 0, 4, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH,  
				new Insets(10, 10, 0, 10), 0, 0));
		add(lbwq1,new GridBagConstraints( 0, 5, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH,  
				new Insets(10, 10, 0, 10), 0, 0));
		add(lbwp2,new GridBagConstraints( 0, 6, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH,  
				new Insets(10, 10, 0, 10), 0, 0));
		add(lbwq2,new GridBagConstraints( 0, 7, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH,  
				new Insets(10, 10, 0, 10), 0, 0));
		add(lbwp3,new GridBagConstraints( 0, 8, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH,  
				new Insets(10, 10, 0, 10), 0, 0));
		add(lbwq3,new GridBagConstraints( 0, 9, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH,  
				new Insets(10, 10, 0, 10), 0, 0));
		add(lbwp4,new GridBagConstraints( 0, 10, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH,  
				new Insets(10, 10, 0, 10), 0, 0));
		add(lbwq4,new GridBagConstraints( 0, 11, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH,  
				new Insets(10, 10, 0, 10), 0, 0));
		add(lbwp5,new GridBagConstraints( 0, 12, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH,  
				new Insets(10, 10, 0, 10), 0, 0));
		add(lbwq5,new GridBagConstraints( 0, 13, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH,  
				new Insets(10, 10, 0, 10), 0, 0));
		...
		add(lbwq10,new GridBagConstraints( 0, 23, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH,  
				new Insets(10, 10, 0, 10), 0, 0));
		// add Combobox
		add(cbOrdnungsauswahl,new GridBagConstraints( 0, 3, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH,  
				new Insets(10, 10, 0, 10), 0, 0));
	...
	public InputPanel(GridBagLayout gridBagLayout) {
		super(new GridBagLayout());
	}
